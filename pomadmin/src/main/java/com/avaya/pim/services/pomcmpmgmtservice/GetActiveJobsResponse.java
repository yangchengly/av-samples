 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Jobs" type="{http://www.w3.org/2001/XMLSchema}int" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "GetActiveJobsResponse")
public class GetActiveJobsResponse {

    @XmlElement(name = "Jobs", type = Integer.class)
    protected List<Integer> jobs;
